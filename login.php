...
// get values of sended inputs by inputs_name
    ...
    $institute = clean_inputs($_POST['institute']);
    $department = clean_inputs($_POST['department']);

// make query
    $sql = "INSERT INTO author(civilid,authorname, institution, department) VALUES('$id','$name', '$institute', '$department')";
    ...
    <div class="container-contact1">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="contact1-form validate-form">
            ...
            <div class="wrap-input1">
                ...
                <input class="input1" type="text" name="id" value="" placeholder="Civil ID" required>
            ...
            <div class="wrap-input1">
                ...
                <input class="input1" type="text" name="name" value="" placeholder="Author Name">
                <span class="shadow-input1"></span>
            </div>

            <div class="wrap-input1">
                <!-- <input class="input1" type="email" name="email" placeholder="Email"> -->
                <input class="input1" type="text" name="institute" value="" placeholder="institute">
                <span class="shadow-input1"></span>
            </div>

            <div class="wrap-input1">
                <input class="input1" type="text" name="department" value="" placeholder="department">
                <span class="shadow-input1"></span>
            </div>
